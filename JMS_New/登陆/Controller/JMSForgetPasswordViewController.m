//
//  JMSForgetPasswordViewController.m
//  JMS_New
//
//  Created by 黄沐 on 20/06/2017.
...
@interface JMSForgetPasswordViewController ()
...
@implementation JMSForgetPasswordViewController
...
- (void)setupViews {
    ...
    //验证码
    self.codeTextField = [JMSInPutTextField inputTextFieldWithFrame:CGRectMake(0, 139, SCREEN_WIDTH, 33) WithPlaceholder:@"验证码" delegate:self];
    ...
    //密码
    self.passwordTextField = [JMSInPutTextField inputTextFieldWithFrame:CGRectMake(0, 139, SCREEN_WIDTH, 33) WithPlaceholder:@"请设置6-20位登录密码" delegate:self];
...
//    //获取验证码按钮
//    self.countDownBtn = [[JMSCountDownButton alloc]init];
...
- (void)sendCodeAction:(JMSCountDownButton *)countDownButton {
    if (!_phoneTextField.textField.text.length) {
